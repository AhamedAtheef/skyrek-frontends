...
export default function Header() {
  ...
  return (
    <header className="bg-[#120c61] w-full  h-[70px] md:h-[78px] shadow-[0_4px_20px_rgba(0,0,0,0.5)] fixed top-0 z-50">
      <div className="w-full h-full flex justify-between items-center px-4 sm:px-6 md:px-8">
        {/* popup */}
        {sideNav && (<div className="w-[80%] overflow-x-scroll md:w-[50%] max-h-[90vh] h-auto fixed top-0 left-0 bg-[#f5f2e3] pb-[20px]">
          <div className="w-full h-[70px] flex justify-between px-[5px] pt-[5px] cursor-pointer border-b-2 border-[#120c61] mb-[30px]" >
            <span className="text-[#000000] flex items-center gap-[5px]  font-semibold"> <CgProfile className="text-3xl text-[#06899b]"/><span className="text-[21px]">Profile</span></span>
            <FaXmark className="text-[#000000] text-1xl cursor-pointer" onClick={()=>setSideNav(false)}/>
        ...
        <div className="hidden lg:flex items-center gap-2 sm:gap-3">
          <div className="hidden">{!isloggedIn ? (
            <>
