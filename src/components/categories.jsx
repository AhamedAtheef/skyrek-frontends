...
export default function CategorieCard({ product }) {
    ...
    return (
        <Link
            ...
            className="group w-[22%] cursor-pointer h-[400px] mt-[10px] rounded-xl overflow-hidden shadow-md border border-gray-200 bg-white hover:shadow-2xl transition-all duration-300
